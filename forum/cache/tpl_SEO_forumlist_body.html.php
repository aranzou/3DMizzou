<?php if (!defined('IN_PHPBB')) exit; $_forumrow_count = (isset($this->_tpldata['forumrow'])) ? sizeof($this->_tpldata['forumrow']) : 0;if ($_forumrow_count) {for ($_forumrow_i = 0; $_forumrow_i < $_forumrow_count; ++$_forumrow_i){$_forumrow_val = &$this->_tpldata['forumrow'][$_forumrow_i]; if (! $_forumrow_val['S_IS_CAT'] && $_forumrow_val['S_FIRST_ROW']) {  ?><!-- category table setup -->
<div class="catmain">
	<div class="catls"></div>
	<div class="cattext"><a href="<?php echo $_forumrow_val['U_VIEWFORUM']; ?>"><?php echo $_forumrow_val['FORUM_NAME']; ?></a></div>
	<div class="catrs"></div>
</div>
...
<div class="catmain">
	<div class="catls"></div>
	<div class="cattext"><?php if ($_forumrow_val['S_IS_CAT']) {  ?><a href="<?php echo $_forumrow_val['U_VIEWFORUM']; ?>"><?php echo $_forumrow_val['FORUM_NAME']; ?></a><?php } else { echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); } ?></div>
	<div class="catrs"></div>
...
<table class="tablebg" cellspacing="1" width="100%">
  <?php } ?>
	...
	<?php } else if ($_forumrow_val['S_IS_LINK']) {  ?>
		...
		<tr>
			<td class="row2" width="50" align="center"><?php echo $_forumrow_val['FORUM_FOLDER_IMG']; ?></td>
			<td class="row2">
		...
		<tr>
			...
			<td class="row2" width="100%">
				<?php if ($_forumrow_val['FORUM_IMAGE']) {  ?>
					...
					<div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>; margin-<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>: 5px;"><?php echo $_forumrow_val['FORUM_IMAGE']; ?></div>				<?php } ?>
