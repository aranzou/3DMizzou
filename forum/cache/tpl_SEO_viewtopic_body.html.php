...
<div class="catmain">
	...
	<div class="cattext">
		...
		<img src="<?php echo (isset($this->_rootref['T_ICONS_PATH'])) ? $this->_rootref['T_ICONS_PATH'] : ''; echo $_postrow_val['POST_ICON_IMG']; ?>" width="<?php echo $_postrow_val['POST_ICON_IMG_WIDTH']; ?>" height="<?php echo $_postrow_val['POST_ICON_IMG_HEIGHT']; ?>" align="left" style="margin-right:10px" alt="" title="" />
		<?php } ?>

		<?php echo $_postrow_val['POST_SUBJECT']; ?>
