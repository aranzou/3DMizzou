...
<tr>
	...
	<td class="row2" width="78%"><input class="post" style="width:390px" type="text" name="subject" size="45" maxlength="<?php if ($this->_rootref['S_NEW_MESSAGE']) {  ?>60<?php } else { ?>64<?php } ?>" tabindex="2" value="<?php echo (isset($this->_rootref['SUBJECT'])) ? $this->_rootref['SUBJECT'] : ''; ?>" /></td>
</tr>
<tr>
	...
	<td class="row2" valign="top">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<?php $this->_tpl_include('posting_buttons.html'); if ($this->_rootref['S_BBCODE_ALLOWED']) {  ?>


			<tr>
			<?php if (! $this->_tpldata['DEFINE']['.']['S_SIGNATURE'] && ! $this->_rootref['S_EDIT_DRAFT']) {  ?>

			<td class="genmed" align="left"><?php echo ((isset($this->_rootref['L_FONT_COLOR'])) ? $this->_rootref['L_FONT_COLOR'] : ((isset($user->lang['FONT_COLOR'])) ? $user->lang['FONT_COLOR'] : '{ FONT_COLOR }')); ?></td>
			<?php } ?>
		...
		<tr>
<td valign="top" style="width: 100%;"><textarea name="message" rows="15" cols="76" tabindex="3" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();" style="width: 98%;"><?php echo (isset($this->_rootref['MESSAGE'])) ? $this->_rootref['MESSAGE'] : ''; ?></textarea></td>	 	</tr>
		</table>
	</td>
...
<tr>
	<td class="row1" colspan="2" align="center"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?>
...
<tr>
<td width="65%" class="cattext" align="left"><?php echo ((isset($this->_rootref['L_WHO_IS_ONLINE'])) ? $this->_rootref['L_WHO_IS_ONLINE'] : ((isset($user->lang['WHO_IS_ONLINE'])) ? $user->lang['WHO_IS_ONLINE'] : '{ WHO_IS_ONLINE }')); ?></td>
</tr>
</table>
		<table class="tablebg" width="100%" cellspacing="1">
		<tr>
